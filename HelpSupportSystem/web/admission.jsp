...
String sql ="SELECT * FROM admission ORDER BY time ASC;";
...
<td style="background:#fff;">
    ...
    <a href="admissionDelete.jsp?idRollNo=<%=resultSet.getString("idRollNo") %>">
...
%>
        ...
        <a href="AdmissionRequest?fullname=<%=resultSet.getString("fullname")%>&idRollNo=<%=resultSet.getString("idRollNo")%>&course=<%=resultSet.getString("course")%>">
